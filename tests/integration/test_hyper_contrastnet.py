...
class TestHyperContrastNet(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cfg = get_hydra_config(
            overrides=[
                ...
                'ml__classifier=hyper_contrastnet',
                'ml__classifier.params.n_trials=1',
                'ml__classifier.params.model.params.n_classes=1',
                'ml__classifier.params.model.params.max_iter=1',
                'ml__classifier.params.model.params.n_test_episodes=1',
                'io__export.params.experiment_name=__banking__'
            ]
        )
